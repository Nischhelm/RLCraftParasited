...
val myrmex_weap_pool = myrmex_weap_table.addPool("myrmex_weapons", 1, 3, 1, 1);
...
LootTweaker.getTable("iceandfire:myrmex_loot_chest").getPool("myrmex_loot_chest").addLootTableEntry("loottweaker:myrmex_gear", 50, 50);
LootTweaker.getTable("iceandfire:myrmex_trash_chest").getPool("myrmex_trash_chest").addLootTableEntry("loottweaker:myrmex_gear", 100, 100);

//------------------ DRAGONBONE ------------------

val dragonbone_table = LootTweaker.newTable("loottweaker:dragonbone_gear");
val dragonbone_pool = dragonbone_table.addPool("dragonbone", 1, 3, 1, 1);
...
val dragonsteel_pool = dragonsteel_table.addPool("dragonsteel", 1, 3, 1, 1);
