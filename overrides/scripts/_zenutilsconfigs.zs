...
.lowerRangedInteger("greaterXpTomeSize", 30970, 0).displayName("Greater XP Tome Size").comment("How much XP the Greater XP Tome should hold. Default 30970 = 100 lvls.").add()
