...
function update() as void {
    ...
    native.lumien.bloodmoon.server.BloodmoonHandler.zenutils_cfg_val = Parasited.minPhaseBloodMoon;
    native.noppes.vc.items.ItemMusket.zenutils_cfg_val = Parasited.musketLoadingTicks;
    native.melonslise.locks.common.container.LockPickingContainer.zenutils_cfg_val = Parasited.lockpickPitchMulti;
    native.melonslise.locks.common.init.LocksItems.zenutils_cfg_val = Parasited.dragonboneLockpickStrength;
    native.atomicstryker.infernalmobs.common.InfernalMobsCore.zenutils_cfg_val = Parasited.infernalIncreaseOnHighPhase;
    native.c4.champions.common.util.ChampionHelper.zenutils_cfg_val = Parasited.championIncreaseOnHighPhase;
