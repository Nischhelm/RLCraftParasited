...
val raceItems = {
//    "Faelis": [],
    "Dragon": ["katana", "longsword", "glaive"],
    "Taurus": ["scythe", "halberd", "greatsword"],
    "Titan":  ["warhammer", "mace", "greatsword", "battleaxe"],
    "Dwarf":  ["hammer", "battleaxe", "warhammer"],
    "Elf":    ["saber", "lance", "staff"],
    "Goblin": ["dagger", "rapier", "mace"],
    "Fairy":  ["spear", "pike"]
} as string[][string];
