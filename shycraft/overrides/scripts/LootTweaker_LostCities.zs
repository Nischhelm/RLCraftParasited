...
//==== Rare Loot (dragon) ====
val dragonRingTable = LootTweaker.newTable("loottweaker:dragon_rings");
...
lostCityRarePool.addItemEntry(<xat:titan_ring>, 1, 1, [Functions.setCount(0, 1)], [], "titan_ring");
...
//==== Uncommon Loot (titan) ====
lostCityUncommonPool.addItemEntry(<xat:dwarf_ring>, 1, 1, [Functions.setCount(0, 1)], [], "dwarf_ring");
