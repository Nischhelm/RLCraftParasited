...
recipes.addShaped("rec131.1",<xat:dragon_gem:1>.withTag({"Elements": {"primary": "xat:fire"}}).withCapNBT({"Parent": {"Elements": {"primary": "xat:fire"}}}),
 [[<contenttweaker:sentient_core>, <variedcommodities:heart>, <xat:dragons_eye:1>],
...
recipes.addShapeless("somuchsilt",<bountifulbaubles:spectralsilt>*8,[<bountifulbaubles:disintegrationtablet>,<quark:rune:3>,<quark:rune:6>,<quark:rune:7>,<quark:rune:8>,<quark:rune:10>,<quark:rune:12>,<quark:rune:13>,<quark:rune:15>]);
...
recipes.addShaped("srp_vileshell_bolster",<srparasites:vile_shell>,
 [[null,<srparasites:ada_bolster_drop>,null],
  [<srparasites:assimilated_flesh>,<srparasites:ada_bolster_drop>,<srparasites:assimilated_flesh>]]);

recipes.addShaped("srp_bladefragment_arachnida",<srparasites:infectious_blade_fragment>,
 [[null,<srparasites:ada_arachnida_drop>,null],
  [<srparasites:assimilated_flesh>,<srparasites:ada_arachnida_drop>,<srparasites:assimilated_flesh>]]);
  
recipes.addShaped("srplance",<srparasites:weapon_lance>,
 [[null,null,<srparasites:infectious_blade_fragment>],
  [<srparasites:vile_shell>,<srparasites:living_core>,null],
  [<srparasites:hardened_bone_handle>,<srparasites:vile_shell>,null]]);
  
recipes.addShaped("srpmaul",<srparasites:weapon_maul>,
 [[<srparasites:vile_shell>,<srparasites:living_core>,<srparasites:vile_shell>],
...
recipes.addShapeless("bottlebegone2",<minecraft:glass_bottle>,[<inspirations:materials:3>]);
  ...
  recipes.addShaped("cleansingtalisman",<rlmixins:cleansing_talisman>,
 [[null,<minecraft:ghast_tear>,null],
  [<minecraft:ghast_tear>,<minecraft:paper>,<minecraft:ghast_tear>],
  [null,<minecraft:ghast_tear>,null]]);

recipes.addShaped("antimagictalisman",<rlmixins:antimagic_talisman>,
